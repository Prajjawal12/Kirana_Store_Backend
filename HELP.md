...
* The original package name 'com.kirana.register.kirana-store-register' is invalid and this project uses 'com.kirana.register.kirana_store_register' instead.
